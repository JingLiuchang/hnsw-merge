...
datasets = ['deep1M', 'sift', 'msmarco1M', 'msong', 'imagenet1m', 'anton1m']
methods = ['random']
merge_m = [2]
et = 0
...
if __name__=="__main__":
    ...
    for db in datasets:
        for method in methods:
            for m in merge_m:
                if m == 2:
                    base_path = f'/mnt/ssd/merge_bench/{db}/random/logs'
                ...
                plt.tight_layout()
                plt.savefig(f'{output}/{db}_merge_time_comparison.png')
