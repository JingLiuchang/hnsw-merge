...
if __name__ == "__main__":
    ...
    if num_clusters <= 2:
        ...
        kmeans_centroids_save_path = f'/mnt/ssd/merge_bench/{db}/overlap/multi-index-data/{num_clusters}parts/{db}_kmeans_centroids.fvecs'
        partition_save_path = f'/mnt/ssd/merge_bench/{db}/overlap/multi-index-data/{num_clusters}parts/'
        partition_index_path = f'/mnt/ssd/merge_bench/{db}/overlap/multi-index-merged/{num_clusters}parts/'
        performance_path = f'/mnt/ssd/merge_bench/{db}/overlap/performance/{num_clusters}parts/'
    ...
    data = data[perm]
    utils.fvecs_write(f'/mnt/ssd/merge_bench/{db}/overlap/multi-index-data/{num_clusters}parts/{db}_shuffle_base.fvecs', data)
    ...
    e = time.time()
    print(f"Total time for preprocessing: {e - s:.2f} seconds")
